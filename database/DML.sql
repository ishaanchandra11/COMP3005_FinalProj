...
-- ============================================
-- CLASS SCHEDULES (Current week and next week)
-- ============================================

-- Assuming current date is around late October 2024
-- Monday classes
INSERT INTO class_schedules (class_id, trainer_id, room_id, scheduled_date, start_time, end_time, current_capacity, status) VALUES
(1, 2, 2, CURRENT_DATE + INTERVAL '1 day', '08:00', '09:00', 15, 'scheduled'), -- Morning Yoga
(4, 3, 4, CURRENT_DATE + INTERVAL '1 day', '06:00', '06:45', 25, 'scheduled'), -- Spin Class
(5, 4, 5, CURRENT_DATE + INTERVAL '1 day', '07:00', '07:30', 18, 'scheduled'), -- HIIT Blast
(7, 1, 1, CURRENT_DATE + INTERVAL '1 day', '10:00', '11:00', 12, 'scheduled'), -- Strength Training

-- Tuesday classes
(3, 2, 3, CURRENT_DATE + INTERVAL '2 days', '10:00', '10:45', 18, 'scheduled'), -- Pilates Core
(6, 6, 2, CURRENT_DATE + INTERVAL '2 days', '18:00', '19:00', 22, 'scheduled'), -- Zumba
(8, 3, 5, CURRENT_DATE + INTERVAL '2 days', '19:00', '19:45', 20, 'scheduled'), -- Cardio Kickboxing

-- Wednesday classes
(2, 2, 2, CURRENT_DATE + INTERVAL '3 days', '08:00', '09:15', 16, 'scheduled'), -- Power Yoga
(4, 3, 4, CURRENT_DATE + INTERVAL '3 days', '06:00', '06:45', 28, 'scheduled'), -- Spin Class
(5, 4, 5, CURRENT_DATE + INTERVAL '3 days', '07:00', '07:30', 20, 'scheduled'), -- HIIT Blast

-- Thursday classes
(3, 2, 3, CURRENT_DATE + INTERVAL '4 days', '10:00', '10:45', 15, 'scheduled'), -- Pilates Core
(6, 6, 2, CURRENT_DATE + INTERVAL '4 days', '18:00', '19:00', 24, 'scheduled'), -- Zumba
(7, 1, 1, CURRENT_DATE + INTERVAL '4 days', '17:00', '18:00', 10, 'scheduled'), -- Strength Training

-- Friday classes
(1, 2, 2, CURRENT_DATE + INTERVAL '5 days', '08:00', '09:00', 20, 'scheduled'), -- Morning Yoga
(4, 3, 4, CURRENT_DATE + INTERVAL '5 days', '06:00', '06:45', 30, 'scheduled'), -- Spin Class (FULL)
(5, 4, 5, CURRENT_DATE + INTERVAL '5 days', '07:00', '07:30', 19, 'scheduled'), -- HIIT Blast

-- Saturday classes
(1, 2, 2, CURRENT_DATE + INTERVAL '6 days', '09:00', '10:00', 18, 'scheduled'), -- Morning Yoga
(6, 6, 2, CURRENT_DATE + INTERVAL '6 days', '14:00', '15:00', 20, 'scheduled'), -- Zumba
(7, 5, 1, CURRENT_DATE + INTERVAL '6 days', '11:00', '12:00', 8, 'scheduled'), -- Strength Training

-- Sunday classes
(1, 2, 2, CURRENT_DATE + INTERVAL '7 days', '10:00', '11:00', 12, 'scheduled'), -- Morning Yoga
(5, 4, 5, CURRENT_DATE + INTERVAL '7 days', '11:00', '11:30', 15, 'scheduled'); -- HIIT Blast
...
(11, 1, 28, 'Bike making unusual noise during high resistance', 'medium', 'reported', '2024-10-20 14:00:00', NULL, NULL, NULL),
(14, 27, 28, 'Bench press bar is loose and needs tightening', 'high', 'in_progress', '2024-10-18 10:00:00', NULL, 'Inspecting hardware', NULL),
(3, 2, 28, 'Elliptical screen flickering', 'low', 'resolved', '2024-10-15 09:00:00', '2024-10-16 15:00:00', 'Replaced display cable', 45.00),
(1, 27, 28, 'Treadmill belt needs lubrication', 'low', 'resolved', '2024-10-10 08:00:00', '2024-10-10 12:00:00', 'Applied lubricant, running smoothly', 25.00),
(5, 1, 28, 'Leg press machine seat adjustment not working', 'medium', 'resolved', '2024-10-05 11:00:00', '2024-10-07 14:00:00', 'Replaced adjustment mechanism', 150.00);
